...
const hiINTranslations: TranslationSet = {
  ...enUSTranslations, // Start with English as fallback
  ...
  'profile.phonePlaceholder': 'उदा. +1 123-456-7890',
...
const knINTranslations: TranslationSet = {
  ...createPlaceholders(enUSTranslations), // Start with English as fallback
...
const urINTranslations: TranslationSet = {
  ...
  'telemedicine.typeDoctorMessagePlaceholder': 'ڈاکٹر کو اپنا پیغام ٹائプ کریں...', 
